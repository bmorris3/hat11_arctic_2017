...
# Image paths
image_paths = sorted(glob('/Users/bmmorris/data/Q4UW01/UT171104/cleaned/HAT*.fits'))#[:-200]
dark_paths = glob('/Users/bmmorris/data/Q4UW01/UT171104/dark_12s.????.fits')
flat_paths = glob('/Users/bmmorris/data/Q4UW01/UT171104/domeflat_r.????.fits')
master_flat_path = 'outputs/masterflat_20171104.fits'
master_dark_path = 'outputs/masterdark_20171104.fits'

# Photometry settings
target_centroid = np.array([[613], [750]])
comparison_flux_threshold = 0.005
aperture_radii = np.arange(40, 60, 1)
centroid_stamp_half_width = 30
psf_stddev_init = 30
aperture_annulus_radius = 10
transit_parameters = params_b

output_path = 'outputs/hat11_20171104.npz'
